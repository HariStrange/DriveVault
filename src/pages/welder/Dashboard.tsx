...
export const WelderDashboard: React.FC = () => {
  const { user } = useAuth();
        ...
        <div className="dashboard-card">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Track your progress through the Europe Welding Project application process
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card className="dashboard-card">
            ...
            <CardContent>
              ...
              <Button 
                onClick={() => navigate('/welder/profile')}
          ...
          <Card className="dashboard-card">
            ...
            <CardContent>
              ...
              <Button 
                onClick={() => navigate('/welder/documents')}
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    <div className="font-medium">Welding Quiz</div>
                    <div className="text-sm text-muted-foreground">
